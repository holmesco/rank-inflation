...
# set up parameters
params: clipperpluspy.ClipperParams = clipperpluspy.ClipperParams()
params.check_lovasz_theta = True
params.cuhallar_params.enable_sparse = True
params.cuhallar_params.options = "/workspace/parameters/cuhallar_params_inexact.cfg"

print('CLIPPER+ start')
start_time = time.perf_counter()
clique_size, clique, certified = clipperpluspy.find_clique(adj, params)
